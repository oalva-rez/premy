...
function displayGuess(rndPlayer, userGuess) {
  ...
  let tableContainer = jquery__WEBPACK_IMPORTED_MODULE_1___default()(".table__content");
  let tableRow = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<div>").addClass("table__row");
  let name = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<div>").append(userGuess.name).addClass("table__cell");
  let team = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<img>", {
    src: userGuess.teamImgSrc,
    width: "47px",
    alt: `${userGuess.team} badge logo`,
  });
  let teamContainer = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<div>", { class: "table__cell" }).append(team);
  let nationality = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<div>")
    .append(userGuess.nationality)
    .addClass("table__cell");
  let position = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<div>").append(userGuess.position).addClass("table__cell");
  let height = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<div>").append(userGuess.getFeet()).addClass("table__cell");
  let age = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<div>").append(userGuess.age).addClass("table__cell");
...
function gameOver(isWin) {
  if (isWin) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()("#search-field").prop("disabled", true); // disable input

    // create winner modal elements
    let heading = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<h1>").text("You Guessed Correctly!");
    let playerName = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<p>").text(_index__WEBPACK_IMPORTED_MODULE_0__.rndPlayer.name);
    let playerImg = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<img>", {
    ...
    let playAgainBtn = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<button>")
      .text("Play Again")
      .click(() => {
        location.reload();
      });
    jquery__WEBPACK_IMPORTED_MODULE_1___default()("#sticky").append(heading, playerName, playerImg, playAgainBtn);
    // open non-closable modal
    jquery__WEBPACK_IMPORTED_MODULE_1___default()("#sticky").modal({
      escapeClose: false,
      clickClose: false,
      showClose: false,
    });
    ...
    let heading = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<h1>").text("You Lose!");
    let text = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<p>").text("Answer:");
    let playerName = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<p>").text(_index__WEBPACK_IMPORTED_MODULE_0__.rndPlayer.name);
    let playerImg = jquery__WEBPACK_IMPORTED_MODULE_1___default()("<img>", {
      src: _index__WEBPACK_IMPORTED_MODULE_0__.rndPlayer.imgSrc,
      alt: `Headshot image of ${_index__WEBPACK_IMPORTED_MODULE_0__.rndPlayer.name}`,
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()("#sticky").append(heading, text, playerName, playerImg, playAgainBtn);
...
(async function initGame() {
  ...
  try {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_6___default()("#submit-guess").click(async function (event) {
      // clear error
      jquery__WEBPACK_IMPORTED_MODULE_6___default()(".err").text("");
      ...
      if (userGuess !== undefined && round > 1) {
        round--;
        jquery__WEBPACK_IMPORTED_MODULE_6___default()(".attempts").text("");
        jquery__WEBPACK_IMPORTED_MODULE_6___default()("#search-field").val("");
        jquery__WEBPACK_IMPORTED_MODULE_6___default()(".attempts").text(round);
        ...
        jquery__WEBPACK_IMPORTED_MODULE_6___default()(".err").text("No player found.");
        jquery__WEBPACK_IMPORTED_MODULE_6___default()("#search-field").val("");
      } else if (round == 1) {
        round--;
        jquery__WEBPACK_IMPORTED_MODULE_6___default()("#search-field").val("");
...
async function getUserGuess() {
  try {
    let searchInput = jquery__WEBPACK_IMPORTED_MODULE_1___default()("#search-field").val();
